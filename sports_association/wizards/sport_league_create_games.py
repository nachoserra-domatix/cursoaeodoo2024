...
class SportLeagueCreateGames(models.TransientModel):
    ...
    allowed_team_ids = fields.Many2many("sport.team", relation="sport_game_team_rel", string="Allowed Teams", 
        compute='_compute_allowed_team_ids', store=True )
    ...
    def create_games(self):
        vals = {
            ...
            "date": self.date,
            "game_line_ids": [Command.create({'team_id': team.id}) for team in self.team_ids]
        }
